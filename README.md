...
## Deploy
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/virus2-0/DogeBot/)
...
```bash
🦄 git clone https://github.com/virus2-0/DogeBot.git
🦄 cd DogeBot
🦄 npm start
```
## For Termux
